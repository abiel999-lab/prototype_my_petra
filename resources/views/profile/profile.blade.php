...
<body class="hold-transition sidebar-mini layout-fixed">
    ...
    <ul class="navbar-nav ml-auto">
            ...
            <div class="dropdown-menu dropdown-menu-right">
                <a href="{{ route('profile.setting') }}" class="dropdown-item">Setting</a>
    ...
    <div class="sidebar">
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
            ...
            <div class="info">
                <a href="{{ route('profile.setting') }}" class="d-block">{{ strtoupper(auth()->user()->name) }}</a>
            </div>
        </div>
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <li class="nav-item">
                    <a href="{{ route('profile.profile') }}" class="nav-link  active ">
...
<div class="row">
        ...
        <div class="card">
            <div class="card-header p-2">
                <ul class="nav nav-pills">
                    <li class="nav-item"><a class="nav-link" href="#tab_account" data-toggle="tab">Account</a></li>
	...
	<form class="form-horizontal" action="#" method="POST">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control " id="nama" name="nama" placeholder="Nama" value="{{ strtoupper(auth()->user()->name) }}" required  disabled >
                            </div>
        </div>
