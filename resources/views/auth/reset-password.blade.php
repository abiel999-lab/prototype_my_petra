                        ...
                        <div class="col-sm-6">
                            <div class="login-wrapper">
                                <div class="tab-content mt-4">
                                    ...
                                    <p style="margin-top: 10px; margin-bottom: 10px;">Please tell us your email and your new password.</p>
                                    ...
                                    <form method="POST" action="{{ route('password.store') }}">
                                        ...
                                        <div class="form-group">
                                            <button type="submit" class="btn btn-lg login-btn"> {{ __('Reset Password') }}</button>
                                        </div>
                                    </form>
