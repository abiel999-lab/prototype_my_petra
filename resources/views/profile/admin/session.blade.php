            ...
            <div class="sidebar">
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                        ...
                        <li class="nav-item">
                            <a href="{{ route('profile.admin.session.show') }}" class="nav-link  active ">
                                            ...
                                            <tbody>
                                                @foreach ($sessions as $index => $session)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <form id="deleteForm-{{ $session->id }}" action="{{ route('profile.admin.session.revoke', $session->id) }}" method="POST">
                                                                @csrf
                                                                @method('DELETE')
