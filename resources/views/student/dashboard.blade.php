                    ...
                    <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                        <div class="mediax">
                            <div class="card-body box-profile text-center">
                                ...
                                <a href="{{ route('profile.student.setting') }}" class="btn btn-outline-primary">Manage
                                    your
                                    Account</a>
        ...
        <div class="content-wrapper">
            ...
            @if ($showMfaReminder)
                <div id="mfa-alert" class="alert alert-warning alert-dismissible fade show mx-3 mt-3" role="alert">
                    ...
                    <a href="{{ route('profile.student.mfa') }}" class="text-primary font-weight-bold ml-2">Go to
                        Security
                        Settings</a>
            ...
            document.addEventListener('DOMContentLoaded', function() {
                if (!localStorage.getItem('mfaAlertDismissed')) {
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            window.location.href = '{{ route('profile.student.mfa') }}';
