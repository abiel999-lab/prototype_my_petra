            ...
            <div class="sidebar">
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                        ...
                        <li class="nav-item">
                            <a href="{{ route('profile.staff.session.show') }}" class="nav-link  active ">
                                ...
                                <div class="card-header d-flex justify-content-between align-items-center">
                                    ...
                                    <div class="ml-auto">
                                        <form id="revokeAllForm"
                                            action="{{ route('profile.staff.session.revokeAll') }}" method="POST">
                                            @csrf
                                            ...
                                            <tbody>
                                                @foreach ($sessions as $index => $session)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <form id="deleteForm-{{ $session->id }}" action="{{ route('profile.staff.session.revoke', $session->id) }}" method="POST">
                                                                @csrf
                                                                @method('DELETE')
